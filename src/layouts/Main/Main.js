...
const Topbar = import('./components').then((e) => e.Topbar);
const Sidebar = import('./components').then((e) => e.Sidebar);
const Footer = import('./components').then((e) => e.Footer);
const AppNavigation = import('./components').then((e) => e.AppNavigation);

const AccountsAppbar = import('components/console/AccountsAppbar').then(
  (e) => e.AccountsAppbar,
);
const DocsAppbar = import('components/console/DocsAppbar').then(
  (e) => e.DocsAppbar,
);
